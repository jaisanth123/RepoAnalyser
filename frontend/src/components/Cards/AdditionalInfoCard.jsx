      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white/60 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-teal-800 font-medium">License</span>
          </div>
          <span className="text-xs font-medium text-teal-900 bg-teal-100 px-2 py-1 rounded">
            {repository.license
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white/60 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-teal-800 font-medium">Created</span>
          </div>
          <span className="text-xs font-medium text-teal-900 bg-teal-100 px-2 py-1 rounded">
        ...
        <div className="flex flex-col items-center text-center p-4 bg-white/60 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-teal-800 font-medium">Homepage</span>
          </div>
          <span className="text-xs font-medium text-teal-900 bg-teal-100 px-2 py-1 rounded">
